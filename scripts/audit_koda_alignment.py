...
(e.g. 'koda_automation') and reports production-readiness alignment gaps while
...
_REFERENCE_PROFILE_DEFAULT = "koda"
...
_PROFILE_EXPECTED_ROOT_ONLY_VS_REFERENCE: dict[str, set[str]] = {
    "koda": _EXPECTED_ROOT_ONLY_VS_REFERENCE,
    "kris_frontend": {
        ".bg-shell",
        ".coderabbit.yaml",
        ".env",
...
_PROFILE_EXPECTED_REFERENCE_ONLY_VS_ROOT: dict[str, set[str]] = {
    "koda": _EXPECTED_REFERENCE_ONLY_VS_ROOT,
    "kris_frontend": {
        ".containerignore",
        ".devcontainer",
        ".dockerignore",
