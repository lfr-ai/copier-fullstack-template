...
class Neo4jKnowledgeGraph:
    ...
    @classmethod
    def from_config(cls, config: dict[str, object]) -> Neo4jKnowledgeGraph:
        """Create a Neo4jKnowledgeGraph instance from a configuration dictionary.
        ...
        Expected config structure::

            {
                ...
                "password": "secret",               # optional (default: "")
        ...
        Returns:
            Neo4jKnowledgeGraph: Configured knowledge graph instance.
        """
        uri = str(config.get("uri", "bolt://localhost:7687"))
