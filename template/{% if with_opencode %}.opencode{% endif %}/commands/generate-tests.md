...
3. **Property tests** in `backend/tests/property/` with `@pytest.mark.property` using
   Hypothesis
...
Use factories from `tests/factories/` for test data. Run all tests and report results
with coverage.
