...
description: >
    Treats registry/naming_registry.json as the single source of truth for shared
    constants. Use when adding routes, fields, enum values, or synchronizing
    backend/frontend identifiers.
---
