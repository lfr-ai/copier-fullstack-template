...
class TestLangChainLLMAdapterFactory:
    ...
    def test_from_config_minimal(self) -> None:
        ...
        from {{ project_slug }}.ai.chains.langchain_adapter import LangChainLLMAdapter
...
class TestSentenceTransformerEmbeddingAdapterFactory:
    ...
    def test_from_config_minimal(self) -> None:
        """from_config() should work with minimal config (defaults)."""
        from {{ project_slug }}.ai.embeddings.sentence_transformer_embeddings import (
...
class TestAzureAISearchVectorStoreFactory:
    ...
    def test_from_config_minimal(self) -> None:
        ...
        from {{ project_slug }}.ai.vector_stores.azure_ai_search_store import (
...
class TestNetworkXKnowledgeGraphFactory:
    ...
    def test_from_config_minimal(self) -> None:
        ...
        from {{ project_slug }}.ai.knowledge_graph.networkx_adapter import (
